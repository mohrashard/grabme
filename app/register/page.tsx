    ...
    if (registrationSuccess) {
        return (
            <div className="min-h-screen font-sans overflow-x-hidden" style={{ background: '#090A0F', color: '#FFFFFF' }}>
                ...
                <div className="flex-1 pt-40 pb-24 px-6 flex justify-center relative">
                    <div className="max-w-2xl w-full bg-[#18181B] rounded-[3rem] border border-white/5 shadow-2xl p-12 text-center space-y-8 relative overflow-hidden">
                        ...
                        <m.div initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
                            <div className="w-24 h-24 bg-green-500/10 rounded-3xl border border-green-500/20 flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-green-500/10">
                                <ShieldCheck className="w-12 h-12 text-green-400" />
                            </div>
                            <h1 className="text-4xl font-black tracking-tight mb-4">Application Received!</h1>
                            <p className="text-white/40 leading-relaxed max-w-sm mx-auto">Your profile has been saved to our high-trust directory. To go live, we need to verify your phone via WhatsApp.</p>
                        </m.div>
    ...
    return (
        <div className="min-h-screen font-sans overflow-x-hidden" style={{ background: '#090A0F', color: '#FFFFFF' }}>
            ...
            <div className="flex-1 pt-40 pb-24 px-6 flex justify-center relative">
                ...
                <div className="max-w-3xl w-full bg-[#18181B] rounded-[2.5rem] border border-white/5 shadow-2xl overflow-hidden relative z-10">
                    {/* Header Section */}
                    <div className="pt-14 pb-12 px-10 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <m.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
                                ...
                                <h1 className="text-4xl lg:text-5xl font-black tracking-tight text-white mb-3">Partner Portal</h1>
                                <p className="text-white/40 text-sm font-bold uppercase tracking-[0.3em] mb-10">Phase {step} of 6</p>
                            </m.div>
