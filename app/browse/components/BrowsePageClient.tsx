            ...
            <main className="pt-24 lg:pt-32 pb-24 px-4 lg:px-6 max-w-7xl mx-auto">
                ...
                <div className="space-y-10 mb-16">
                    <div className="space-y-4">
                        ...
                        <p className="text-white/40 text-sm font-medium max-w-md">Browse verified electricians, plumbers, and home workers across Sri Lanka. High trust, zero commission.</p>
                    </div>
                ...
                <div className="flex items-center justify-between mb-8 px-2">
                    <p className="text-xs font-bold text-white/30 uppercase tracking-[0.2em]">Showing {filteredWorkers.length} Verified Partners in Sri Lanka</p>
                    ...
                    <AnimatePresence mode="popLayout">
                        {filteredWorkers.length === 0 ? (
                            <m.div 
                                ...
                                className="col-span-full py-24 md:py-32 flex flex-col items-center text-center space-y-8 bg-[#18181B]/50 border border-white/5 rounded-[3rem] shadow-2xl backdrop-blur-sm px-6"
                            >
                                <div className="w-20 h-20 md:w-24 md:h-24 bg-indigo-500/10 rounded-[2rem] flex items-center justify-center border border-indigo-500/20 shadow-2xl shadow-indigo-500/10">
                                    <SearchX className="w-10 h-10 md:w-12 md:h-12 text-indigo-400" />
                                </div>
                                <div className="space-y-3">
                                    <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tight">No Baas available in this city yet</h3>
                                    <p className="text-white/30 text-[10px] md:text-sm max-w-xs mx-auto font-bold uppercase tracking-widest leading-relaxed">
                            ...
                            >
                                ...
                                <div className={viewMode === 'grid' ? "space-y-6" : "flex items-center gap-4 md:gap-6 w-full md:flex-1 min-w-0"}>
                                    ...
                                    <div className="space-y-1 min-w-0 font-sans">
                                        ...
                                        <div className="flex flex-wrap items-center gap-2 text-[10px] font-black uppercase tracking-widest text-indigo-500">
                                            <span>{w.trade_category}</span>
                                            <span className="text-white/10">•</span>
                                            <span className="text-white/40">{w.years_experience} Years Experience</span>
                                        </div>
                                        {viewMode === 'list' && (
                                            <p className="text-sm text-white/30 truncate mt-2">{w.short_bio || 'Verified service professional in Sri Lanka.'}</p>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className={viewMode === 'grid' ? "space-y-6" : "flex flex-col md:flex-row items-start md:items-center gap-4 w-full md:w-auto mt-4 md:mt-0"}>
                                    <div className="flex items-center gap-4 text-xs font-bold text-white/20">
                                        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white/5 rounded-full border border-white/5" aria-label={`Location: ${w.home_district}`}>
                ...
                <div className="mt-24 py-12 border-t border-white/5 flex flex-col items-center gap-8 text-center">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-xl font-bold">Safe. Verified. Sri Lankan Network.</h3>
                        <p className="text-sm text-white/40 max-w-sm">Every single partner is manually verified. High trust, zero commission, direct WhatsApp contact.</p>
                    </div>
                </div>
            </main>
        </div>
