...
export default async function BrowsePage({ searchParams }: PageProps) {
  ...
  const { data: workers, error } = await supabaseAdmin
    .from('workers')
    .select('id, slug, full_name, trade_category, home_district, specific_areas, profile_photo_url, short_bio, is_featured, is_identity_verified, is_reference_checked, years_experience, sub_skills, is_available_now')
